...
# National mean height of people is the weighted average of the gender means. The weight for each gender is its proportion to the national population.
# The overall proportion of people taller than 70 inches is the weighted average of gender proportions. The weight for each gender is its proportion to the national population.
